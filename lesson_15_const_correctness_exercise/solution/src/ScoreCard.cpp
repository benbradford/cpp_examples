...
bool ScoreCard::has_scored(unsigned int scoreCategory) const {

	return mCategoryScores[scoreCategory-1] != -1;
}

void ScoreCard::print_scores() const {
...
bool ScoreCard::full_house() const {
...
unsigned int ScoreCard::large_straight() const {
...
unsigned int ScoreCard::small_straight() const {
...
unsigned int ScoreCard::total_score() const {
